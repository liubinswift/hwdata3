	...
	//	String station = (String) obj.get("station_name");
		...
		try {
			if(flag.equalsIgnoreCase("redisseminators")){
				getRedisseminators(reportDate);//获得所有转播机构
...
//					}
	 ...
	 * 从运行图表中，取出有效的转播机构。
	 */
	public void getRedisseminators(String reportDate){
		String sql="select distinct(t.redisseminators) from zres_runplan_tab t where t.runplan_type_id=2 and t.is_delete=0  ";
		if(reportDate!=null){
	 ...
	 * 根据运行图和语言表取出有效的语言名称
	 */
	public void getLanguage(String reportDate){
		String sql = "select  distinct(zlt.language_name) from zres_runplan_tab t,zdic_language_tab zlt where  t.runplan_type_id=2  and t.language_id=zlt.language_id and t.is_delete=0 and zlt.is_delete=0 ";
		if(reportDate!=null){
			sql+=" and t.valid_end_time>to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss')  and t.valid_start_time<=to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss') ";
		}
	 ...
	 * 根据运行图和服务区表取出有效的区域名称
	 */
	public void getArea(String reportDate){
		
		String sql="select distinct(dst.chinese_name) from zres_runplan_tab t,dic_servicesarea_tab dst where  t.runplan_type_id=2  and t.service_area=dst.chinese_name and t.is_delete=0";
		if(reportDate!=null){
			sql+=" and t.valid_end_time>to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss')  and t.valid_start_time<=to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss') ";
		}
		try {
	 ...
	 * 从运行图中获取播音时段
	 */
	 public void getBroadcastTime(String reportDate){
	    	String sql="select distinct(t.start_time||'-'||t.end_time) as broadcasttime from zres_runplan_tab t where t.is_delete=0  ";
	    	if(reportDate!=null){
				sql+=" and t.valid_end_time>to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss')  and t.valid_start_time<=to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss') ";
			}
	    	try {
	 ...
	 /**
		 * 从运行图中获取收测站点
		 */
		 public void getwebSite(String reportDate){
		    	String sql="select t.mon_area,t.xg_mon_area from zres_runplan_tab t where t.is_delete=0  and (t.mon_area||t.xg_mon_area) is not null ";
		    	if(reportDate!=null){
					sql+=" and t.valid_end_time>to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss')  and t.valid_start_time<=to_date('"+reportDate+"','yyyy-mm-dd hh24:mi:ss') ";
				}
		    	try {
	...
	public HashMap calculateRunplanByRedisseminators(String redisseminators,ASObject obj){
		...
		String sql="select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0    and t.redisseminators like '%"+redisseminators+"%'";
		String sql1 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0   and t.redisseminators like '%"+redisseminators+"%' and t.mon_area is not null ";
		String sql2 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0   and t.redisseminators like '%"+redisseminators+"%' and t.xg_mon_area is not null ";
	...
	public HashMap calculateRunplanByLanguage(String language_name,ASObject obj){
		...
		String band = (String) obj.get("band");
		String website = (String) obj.get("website");
		String sql="select * from zres_runplan_tab t,zdic_language_tab zlt where  t.runplan_type_id=2 and t.is_delete=0   and t.language_id=zlt.language_id and zlt.language_name = '"+language_name+"' ";
		String sql1 = "select * from zres_runplan_tab t,zdic_language_tab zlt where  t.runplan_type_id=2 and t.is_delete=0   and t.language_id=zlt.language_id and zlt.language_name = '"+language_name+"' and t.mon_area is not null  ";
		String sql2 = "select * from zres_runplan_tab t,zdic_language_tab zlt where  t.runplan_type_id=2 and t.is_delete=0  and t.language_id=zlt.language_id and zlt.language_name = '"+language_name+"' and t.xg_mon_area is not null ";
		if(languageName!=null&&!languageName.equalsIgnoreCase("全部")){
			sql+=" and t.language_id='"+language_id+"'";
			sql1+=" and t.language_id='"+language_id+"'";
			sql2+=" and t.language_id='"+language_id+"'";
	...
	public HashMap calculateRunplanByArea(String area,ASObject obj){
		...
		String band = (String) obj.get("band");
		String website = (String) obj.get("website");
		String sql="select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0  and t.service_area like '%"+area+"%' order by t.service_area";
		String sql1 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0  and t.service_area like '%"+area+"%' and t.mon_area is not null  order by t.service_area";
		String sql2 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0  and t.service_area like '%"+area+"%' and t.xg_mon_area is not null order by t.service_area";
		if(languageName!=null&&!languageName.equalsIgnoreCase("全部")){
			sql+=" and t.language_id='"+language_id+"'";
			sql1+=" and t.language_id='"+language_id+"'";
			sql2+=" and t.language_id='"+language_id+"'";
	...
	public HashMap calculateRunplanByTime(String broadcastTime,ASObject obj){
		String sql="select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0   and t.start_time='"+broadcastTime.split("-")[0]+"' and t.end_time='"+broadcastTime.split("-")[1]+"' ";
		String sql1 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0  and t.start_time='"+broadcastTime.split("-")[0]+"' and t.end_time='"+broadcastTime.split("-")[1]+"'" +
				" and t.mon_area is not null  ";
		String sql2 = "select * from zres_runplan_tab t where  t.runplan_type_id=2 and t.is_delete=0  and t.start_time='"+broadcastTime.split("-")[0]+"' and t.end_time='"+broadcastTime.split("-")[1]+"'" +
	...
	public HashMap calculateRunplanByWebsite(String website,ASObject obj){
		String sql="select * from zres_runplan_tab t where  t.runplan_type_id=2 and  t.is_delete=0  and (t.mon_area like '%"+website+"%' or t.xg_mon_area like '%"+website+"%') ";
