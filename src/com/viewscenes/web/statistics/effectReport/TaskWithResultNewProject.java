 ...
 */
public class TaskWithResultNewProject implements Callable<LinkedHashMap> {
        ...
        public TaskWithResultNewProject(String starttime, String endtime, String my_report_type, String report_type, ASObject asobj, String report_id, String type) {
    ...
    public LinkedHashMap statisticsReportCondition71(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        if(my_report_type.equals("1")){//国际台
            ...
            sql ="select    play_time,language_name,frequency freq,station_name stationname ,direction ,power,head_code headcode," +
                    "service_name service_name_headend,head_type_id type_id ,head_name shortname ,counto ,service_area , valid_start_time ,valid_end_time," +
                    "stream_start_datetime start_datetime,  dis_runplan_id,disturb from radio_stream_mark_result_tab " +
                    " where counto is not null and report_type=1 "+
                    " and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
                    " and runplan_type_id="+my_report_type+""+
                    " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                    " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') ";
        } else if(my_report_type.equals("2")){//海外落地

            sql ="select    play_time,language_name,frequency freq,station_name stationname ,direction ,redisseminators,power,head_code headcode," +
                    "service_name service_name_headend,head_type_id type_id ,head_name shortname ,counto ,service_area , valid_start_time ,valid_end_time," +
                    "stream_start_datetime start_datetime,  dis_runplan_id,disturb from radio_stream_mark_result_tab " +
                    " where counto is not null and report_type=1 "+
                    //" and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
        ...
        if(headcodes!=null&&!headcodes.equalsIgnoreCase("")){
            if(headcodes.split(",").length>1){
                ...
                for(int m=0;m<ss.length;m++){
                    newsql+=" HEAD_CODE like '%"+ss[m]+"%' or";
                }
                sql+=" and ("+newsql.substring(0, newsql.length()-2)+")";
            }else{
                sql+=" and HEAD_CODE like '%"+headcodes.substring(0, headcodes.length()-1)+"%'";
            }

        }
        sql+=" order by headname,freq ";
...
//		String headcodes = null;//test
        ...
        if(my_report_type.equals("1")){//国际台
            valid_end_timeString=" and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') ";
        }
        String  sql ="select head_code headcode, service_name service_name_headend, head_type_id type_id, head_name shortname , " +
                "counto ,service_area ,state_name, stream_start_datetime start_datetime  from radio_stream_mark_result_tab " +
                " where counto is not null and report_type=1  and service_name is not null "+
                valid_end_timeString+
                " and runplan_type_id="+my_report_type+""+
                " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') order by shortname ";
        GDSet gd = DbComponent.Query(sql);
...
//					continue;
    ...
    public LinkedHashMap statisticsReportCondition51(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        String sql ="select    play_time,head_code headcode,service_name service_name_headend,head_type_id type_id " +
                "head_name shortname ,counto ,service_area ,state_name,frequency freq from radio_stream_mark_result_tab " +
                " where counto is not null and report_type=1  and service_area is not null "+
                valid_end_timeString +
                " and runplan_type_id="+my_report_type+""+
                " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') ";
...
//			System.out.println("freq_shortname=="+freq_shortname);
    ...
    public LinkedHashMap statisticsReportCondition41(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        String sql ="select   counto ,service_area , state_name, service_name service_name_headend from radio_stream_mark_result_tab " +
                " where counto is not null and report_type=1  and service_area is not null "+
                valid_end_timeString +
                " and runplan_type_id="+my_report_type+""+
                " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
...
//					 String stationname = gd.getString(i, "stationname");
    ...
    public LinkedHashMap statisticsReportCondition32(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        String sql ="select  head_code headcode, service_name service_name_headend,head_type_id type_id ,head_name shortname ,counto ," +
                " service_area ,state_name,language_name from radio_stream_mark_result_tab   " +
                " where counto is not null and report_type=1  and service_name is not null   "+
                valid_end_timeString +
                " and runplan_type_id="+my_report_type+""+
                " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
        ...
        sql+=" order by headcode,language_name ";
        GDSet gd = DbComponent.Query(sql);
...
//		String headcodes = null;//test
        ...
        if(my_report_type.equals("1")){//国际台
             ...
             sql ="select    runplan_id  ,play_time,language_name,frequency freq,station_name stationname ,direction ,power,head_code headcode," +
                     "service_name service_name_headend,head_type_id type_id ,head_name shortname ,counto ,service_area , valid_start_time ,valid_end_time," +
                     "stream_start_datetime start_datetime,  dis_runplan_id,disturb,program_type from radio_stream_mark_result_tab " +
                     " where counto is not null and report_type=1 "+
                     " and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
                     " and runplan_type_id="+my_report_type+""+
                     " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
            ...
            sql+=" order by shortname,stationname,freq";
        } else if(my_report_type.equals("2")){//海外落地
            sql="select    runplan_id  ,play_time,language_name,frequency freq,station_name stationname ,direction ,redisseminators,power,head_code headcode," +
                    "service_name service_name_headend ,head_name shortname ,counto ,service_area ,valid_start_time ,valid_end_time," +
                    "stream_start_datetime start_datetime,  dis_runplan_id,disturb,program_type from radio_stream_mark_result_tab "+
                    " where counto is not null and report_type=1  and service_area is not null "+
                    " and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
                    " and runplan_type_id="+my_report_type+""+
    ...
    public LinkedHashMap statisticsReportCondition21(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        if(my_report_type.equals("1")){//国际台
            ...
            sql ="select   head_code headcode,service_name service_name_headend, head_type_id type_id ," +
                    "head_name shortname ,counto ,service_area ,state_name,station_name stationname ,redisseminators from radio_stream_mark_result_tab " +
                    " where counto is not null and report_type=1 and service_name is not null "+
                    " and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
                    " and runplan_type_id="+my_report_type+""+
                    " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                    " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') order by headcode,stationname ";
        } else if(my_report_type.equals("2")){//海外落地
            ...
            sql ="select   head_code headcode,service_name service_name_headend, head_type_id type_id ," +
                    ...
                    " and runplan_type_id="+my_report_type+""+
                    " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                    " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') order by headcode";
        }
        GDSet gd = DbComponent.Query(sql);
...
//							 }
    ...
    public LinkedHashMap statisticsReportCondition22(String starttime, String endtime,String my_report_type,String report_type,ASObject asobj,String report_id) throws Exception{
        ...
        String order="";
        if(my_report_type.equals("1")){//国际台
            order=" order by headcode,stationname ";
            sql ="select   head_code headcode,service_name service_name_headend, head_type_id type_id ," +
                    "head_name shortname ,counto ,service_area ,state_name,station_name stationname ,redisseminators from radio_stream_mark_result_tab " +
                    " where counto is not null and report_type=1 "+
                    " and valid_end_time>=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') "+
            ...
            order=" order by headcode,redisseminators ";
            sql ="select   head_code headcode,service_name service_name_headend, head_type_id type_id ," +
                    "head_name shortname ,counto ,service_area ,state_name ,redisseminators from radio_stream_mark_result_tab " +
                    " where counto is not null and report_type=1 and service_name is not null "+
                    " and runplan_type_id="+my_report_type+""+
                    " and stream_start_datetime>=to_date('"+starttime+"','yyyy-mm-dd hh24:mi:ss')" +
                    " and stream_end_datetime<=to_date('"+endtime+"','yyyy-mm-dd hh24:mi:ss') ";
