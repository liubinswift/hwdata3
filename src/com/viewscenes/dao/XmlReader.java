...
public class XmlReader {
  ...
  static {
    ...
    try {
      ...
      URL configFile = XmlReader.class.getClassLoader().getResource(
  ...
  /**
   ...
   public static List getAttrValueList(String itemName, String childName,String atrrName,String atrrName2,String atrrName3) {
     ...
     for(int i=0;i<list.size();i++)
     {
           List li=new ArrayList();
           Element el=(Element)list.get(i) ;
           String info1=el.getAttributeValue(atrrName);
           String info2=el.getAttributeValue(atrrName2);
           String info3=el.getAttributeValue(atrrName3);
           li.add(info1);
           li.add(info2);
           li.add(info3);
           iplist.add(li);
  ...
  public static String getAttrValue(String itemName, String childName, String atrrName) {
    ...
    Element ele = XmlReader.getConfigItem(itemName);
  ...
  public static String getNextAttrValue(String itemName, String atrrName, String atrrValue,
    ...
    Element ele = XmlReader.getItem(itemName, atrrName, atrrValue);
